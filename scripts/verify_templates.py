...
errors=[]; files=sorted((ROOT/'templates').glob('*/*/*.dotx'))
if len(files)!=12: errors.append(f'expected 12 templates, got {len(files)}')
for p in files:
...
print(f'OK: verified {len(files)} templates')
